...
— **뒷받침**: S0 = 10M 파라미터 1 kHz sim-trained 전신 제어기가 종래 수기 제어 스택("C++ 109,504줄")을 대체했다는 사례 (§2, 흔한 오해 4) — 48강과 동일 출처, 회사 발표 수치.
...
— **뒷받침**: 450M DiT 30 Hz 학습 정책이 기존 MPC급 전신 제어 위에 얹히는 구조 (§2, 번역 박스, 토론 질문 7) — 48강과 동일 출처, 회사 발표.
