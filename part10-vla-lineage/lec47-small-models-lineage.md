...
flowchart TD
    ...
    P0X -.->|"템플릿 계승"| GN1["G0강T N1 '25.3"] --> GN17["N1.7 '26.4"] -.-> N2X["N2 / WAM '26 예고"]
...
- **2시대 '24 (19-44강)**: 오픈화 + 연속 액션 헤드. Octo/OpenVLA가 재현·공개, π0가 flow expert 템플릿 확립, RDT·CogACT·TinyVLA가 설계 공간 탐색.
- **3시대 '25-26 (21-48강)**: 분화 — 계층·dual-system(π0.5, G0강T, Helix), RL 사후 훈련(RECAP), latent action(GO-1), 경량 온보드(SmolVLA, Redwood), 그리고 world model 수렴(N2/WAM)의 예고.
