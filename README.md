...
## ✅ 진행 상황 — 1차 전 과정(0–65강) 완성

이 저장소는 **0–65강 전 66강의 1차 집필을 완료**했습니다 — 전 강의 v3(핵심 수식 3단·실행 검증 코드·그림 ≥5). AI(Claude)와 함께 만든 살아있는 자료라 프론티어(Part 15)·모델 계보는 계속 갱신됩니다. (v3 = 수식 3단·실행 검증 코드·그림 ≥5)
...
- **전 과정(0–65강) 학습 가능**: 로봇의 몸·물리·구동·제어(1–24) → 딥러닝·Transformer·VLM·행동학습(25–41) → VLA 계보·실물 통합(42–50) → 환경·데이터·평가·시스템 통합·프론티어(51–65). 모든 강의 코드·수치·인용 검증 완료.
...
part15-frontier/               63–65 프론티어·논문읽기·캡스톤 ✅ 작성완료
